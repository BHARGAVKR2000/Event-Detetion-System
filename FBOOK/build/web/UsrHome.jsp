                                ...
                                <div class="col-md-10 mb" style="background: white;margin-left: 70px;">
                                    ...
                                    <center>
                                        <div class="showback">                                           
                                            ...
                                            <form name="uploadpost" id="uploadpost" style="display: none;" onsubmit="return pstVld();" id="uploadpost" enctype="multipart/form-data" method="post">
                                            ...
                                            <form style="display: none;" name="uploadposturl" id="uploadposturl" onsubmit="return pstVld1();" id="uploadpost" method="post">
                                                <input type="hidden" class="form-control" name="Umail" id="Umail" value="<%=uname%>" readonly=""><br>   
                                                <input type="hidden" class="form-control" name="UName" id="UName"  value="<%=oname%>" readonly=""><br>                                                     
                                                <input type="hidden" class="form-control" name="CITY" id="CITY"  value="<%=location%>" readonly=""><br>                                                
                            ...
                            <%  int fril = mbar.fredlenth(uname);
                                if (fril > 0) {
                                    ...
                                    while (rs6.next()) {
                                        ...
                                        fsts[dri] = rs6.getString("status1");
                                        rdi++;
                                    }
                                    for (dd = 0;
                                            dd < fril;
